function [k_msd]=plotsub_msd(filename, positioninthefig1, title1, T, subs, maxlag)
load(filename);
disp(filename);
kb=1.38e-23;
...
[k_msd,Ek_msd, tau0, sigma2_tau0, D_msd, ED_msd, tau, mmsd, Emsd, indc]=msd_nfilt(x(1:subs:size(x,1),:),T,dt*subs,maxlag);
