...
%BAYESIAN
[k_bayes(nj), sigma_k_bayes(nj), gamma_bayes(nj), sigma_gamma_bayes(nj), D_bayes(nj), sigma_D_bayes(nj)]= bayesian(reshape(x, [size(x,1)*size(x,2),1 ]), dt,T, r);
end
...
scatter(dnn(1:30), k_bayes*1e6,  'DisplayName', 'BAYES')
legend