...
ylabel('$x(\mu m)$','Interpreter','Latex','FontSize',20);
...
scatter(b,ptx,60,'o','markerfacecolor', [0.00,0.45,0.74],'markeredgecolor',[0.00,0.45,0.74])
