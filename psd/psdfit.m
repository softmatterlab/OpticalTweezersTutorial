function [fc_exp,D_exp,Efc_exp,ED_exp,f,XX,fw_mean,Pk,fcut,h]=psdfit(Xs,dt,Nb,pc)
...
for j=1:Nexp
    ...
    c=fit(fwc',Pkc,ft,'Weights',wc,'StartPoint',[a0,b0]);
    ...
    Efc_exp=2*fc_exp*(cint(2,1)-cint(1,1))/2;
    
    ED_exp=2*pi^2*(cint(2,2)-cint(1,2))/2;    
