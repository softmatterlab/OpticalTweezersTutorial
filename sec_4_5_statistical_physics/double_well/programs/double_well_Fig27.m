clear all
close all
load('../data/data_doblePozo_CP.mat');
...
save('../results/MapafuerzasDoblePozo.mat')
...
save('../results/PerfilPotencialFuerzaDoblePozo.mat','X0','Y0','poty0',...
    'X10','Y10','potx1',...
    'X20','Y20','potx2',...
    'X30','Y30','potx3',...
...
load('../results/PerfilPotencialFuerzaDoblePozo.mat')
load('../results/MapafuerzasDoblePozo.mat')
addpath 'general'
%quiver and prob
...
save('../results/CriticalPoints.mat')
%% Compute the mean passage or residence time



load('../results/CriticalPoints.mat','tau0_A','tau0_B','tau01d_A','tau01d_B')
load('../results/PerfilPotencialFuerzaDoblePozo.mat','DUA','DUB')
...
load('../results/CriticalPoints.mat')
addpath general
%time series
