...
LL= legend ({'RBC1 UP','RBC1 DOWN','RBC2 UP','RBC2 DOWN'},'Interpreter','latex','Box','off','Position',[0.63 0.69 0.1 0.2])
LL.FontSize = 18
...
LL= legend ({'RBC1 UP','RBC1 DOWN','RBC2 UP','RBC2 DOWN'},'Interpreter','latex','Box','off','Position',[0.13 0.69 0.1 0.2])
LL.FontSize = 18
