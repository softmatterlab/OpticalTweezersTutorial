...
Run potential_analysis.m to obtain the values of the stiffness given by the potential method. This will call the functions, [/pot/prob_dist_energy.m](prob_dist_energy.m),  pot_lfit.m and pot_nlfit.m contained in the folder **pot**.
