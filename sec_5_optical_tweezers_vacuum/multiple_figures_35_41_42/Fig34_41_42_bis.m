...
p(3)=plot(f1fit, PSD1fit,'--', 'LineWidth', 2.5, 'Color', 'black')


p(2)=plot([xx0 xx0],[1e-3 1e1],'--','LineWidth', 1.5, 'color',col3)
plot([xx1 xx1],[1e-3 1e1],'--','LineWidth', 1.5, 'color',col3)
plot([xx2 xx2],[1e-3 1e1],'--','LineWidth', 1.5, 'color',col3)
ylabel({'PSD','$\hat{S}_{qq}$ (bit$^2$ Hz$^{-1}$)'}, 'Interpreter', 'Latex')
...
set(gca,'TickLabelInterpreter','latex', 'linewidth',1.5,'FontSize',25,'TickLength',[0.02, 0.01], 'XMinorTick','on','xlim', [20,60],'ylim', [2e-2,5],...
  'Xtick',[20 30 40 50 60 ],'Xticklabel',[],'Ytick',[1e-1  1e-0],'yscale', 'log');
...
plot(f2fit, PSD2fit,'--', 'LineWidth', 2.5, 'Color', 'black')
ylabel({'PSD','$\hat{S}_{vv}$ (bit$^2$ Hz$^{-1}$)'}, 'Interpreter', 'Latex')


LL= legend ([p(1)  p(3) p(2)],'z detector signal','fit','drive', 'Interpreter', 'Latex','Box','off','Position',[275 495 1 1], 'boxoff')
LL.FontSize = 18;
LL.Box = 'off';
