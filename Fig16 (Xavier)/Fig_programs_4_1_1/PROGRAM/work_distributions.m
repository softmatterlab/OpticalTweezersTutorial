...
addpath('F:\Document\GitHub\tweezers_AOP_tutorial\Xavier\Fig_programs_4_1_1\PROGRAM\Functions/')

%path to data
dirpath='F:\Document\GitHub\tweezers_AOP_tutorial\Xavier\Fig_programs_4_1_1\RAW_DATA/';
%output path
outpath='F:\Document\GitHub\tweezers_AOP_tutorial\Xavier\Fig_programs_4_1_1\RESULTS/';
...
xlabel('$L \rm(nm)$','Interpreter','Latex', 'FontSize',30);
ylabel('$f$(pN)','Interpreter','Latex', 'FontSize',30)
xlim([-180,-40])
pointsx=[l0,lf];
pointsy=[mean(fminu),mean(fmaxf)];
plot(pointsx,pointsy,'o', 'MarkerSize', 15, 'MarkerFaceColor', 'k');
