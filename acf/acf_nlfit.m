function [k_acf, sigma_k_acf, D_acf, sigma_D_acf, gamma_acf, sigma_gamma_acf, tau, mc, Ec, indc, tau0_gamma, c0_exp]=acf_nlfit(Vx,T,dt)
...
tau0_gamma=params(2)*max_tau;
sigma_tau0_exp=sigma(2)*max_tau;
...
gamma_acf=k_acf*tau0_gamma;
sigma_gamma_acf=k_acf*sigma_tau0_exp+sigma_k_acf*tau0_gamma;
