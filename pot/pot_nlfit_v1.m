function [xbins, mU, EU, k_pot, Ek_pot, mhist, Ehist, h0, x_eq]=pot_nlfit_v1(x,T,nb)
...
plot(xbins*1e6,h0*exp(-1/2*k_pot*(xbins-x_eq).^2/(kb*T))*1e-6,'LineWidth',1,'Color',col2)
