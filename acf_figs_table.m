...
[k_acf_lf_I,sigma_k_acf_lf_I,D_acf_lf_I,sigma_D_acf_lf_I,gamma_acf_lf_I, sigma_gamma_acf_lf_I , k_acf_nl_I, sigma_k_acf_nl_I, D_acf_nl_I, sigma_D_acf_nl_I,gamma_acf_nl_I, sigma_gamma_acf_nl_I, tau0_exp_lf_I, tau0_exp_nl_I, Xpix, Ypix]=plotsub_acf('Data_positions_Fig9_1P2_S.mat',[bx1 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleI, T, subs,1.1,3.21,5);
 disp('................')
 disp(titleI)
...
[k_acf_lf_II,sigma_k_acf_lf_II,D_acf_lf_II,sigma_D_acf_lf_II,gamma_acf_lf_II, sigma_gamma_acf_lf_II , k_acf_nl_II, sigma_k_acf_nl_II, D_acf_nl_II, sigma_D_acf_nl_II,gamma_acf_nl_II, sigma_gamma_acf_nl_II, tau0_exp_lf_II, tau0_exp_nl_II]=plotsub_acf('Data_positions_Fig9_1P4_S.mat',[bx1+bx2+xwi 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleII, T, subs,1.1,8.2,0);
disp('................')
disp(titleII)
disp('Autocorrelation function analysis by linear fitting')
...
[k_acf_lf_III,sigma_k_acf_lf_III,D_acf_lf_III,sigma_D_acf_lf_III,gamma_acf_lf_III, sigma_gamma_acf_lf_III , k_acf_nl_III, sigma_k_acf_nl_III, D_acf_nl_III, sigma_D_acf_nl_III,gamma_acf_nl_III, sigma_gamma_acf_nl_III, tau0_exp_lf_III, tau0_exp_nl_III]=plotsub_acf('Data_positions_Fig9_1P6_S.mat',[bx1+2*bx2+2*xwi 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleIII, T, subs, 1.1,13,0);
