...
[k_pot_lf_I, k_pot_nl_I]=plotsub_eq('Data_positions_Fig9_1P2_S.mat',[bx1 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleI, T, subs)

titleII='Experiment II, P=6.0mW';
[k_pot_lf_II, k_pot_nl_II]=plotsub_eq('Data_positions_Fig9_1P4_S.mat',[2*bx1+xwi+bx2 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleII, T, subs)


titleIII='Experiment III, P=9.2mW';
[k_pot_lf_III, k_pot_nl_III]=plotsub_eq('Data_positions_Fig9_1P6_S.mat',[3*bx1+2*xwi+2*bx2 0 xwi 0]/Xpix + [0 by1 0 ywi]/Ypix, titleIII, T, subs)
