function [k_acf_lf,sigma_k_acf_lf,D_acf_lf, sigma_D_acf_lf,gamma_acf_lf, sigma_gamma_acf_lf , k_acf_nl, sigma_k_acf_nl, D_acf_nl, sigma_D_acf_nl,gamma_acf_nl, sigma_gamma_acf_nl, tau0_exp_lf,sigma_tau0_exp_lf, tau0_exp_nl, sigma_tau0_nl,Xpix, Ypix]=plotsub_acf(filename, positioninthefig1, title1, T, subsample, partau0, end_plot,aa)
%function [k_acf_lf,sigma_k_acf_lf,D_acf_lf, sigma_D_acf_lf,gamma_acf_lf, sigma_gamma_acf_lf , k_acf_nl, sigma_k_acf_nl, D_acf_nl, sigma_D_acf_nl,gamma_acf_nl, sigma_gamma_acf_nl, tau0_exp_lf,sigma_tau0_exp_lf, tau0_exp_nl, sigma_tau0_nl,Xpix, Ypix]=plotsub_acf(filename, positioninthefig1, title1, T, subsample, partau0, end_plot,aa)
%computes the autocorrelation function analysis and plots the fit
%it calls the functions acf_lfit and acf_nlfit
load(filename);
