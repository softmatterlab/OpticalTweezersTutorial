...
%     end
    ...
    options_para_expe={'o','Color','k','MarkerFaceColor',colo{mod(n-1,num_col)+1}};
    options_perp_expe={'v','Color','k','MarkerFaceColor',colo{mod(n-1,num_col)+1}};
...
text(1.475+x_shift,0.75,'$D_{\perp}$','Interpreter','Latex','fontsize',fst,...
    'HorizontalAlignment','right','VerticalAlignment','bottom');

text(1.475+x_shift,0.30,'$D_{\parallel}$','Interpreter','Latex','fontsize',fst,...
...
%     figure(hf_drift);
    ...
    errorbar(B_expe{ik}(ifull)',dripar_av_expe{ik}(ifull)',dripar_std_expe{ik}(ifull)',options_para_expe{:});
%     errorbar(B_expe{ik}(ifull)',dripar_av_expe{ik}(ifull)',dripar_std_expe{ik}(ifull)',options_drift_para_expe{:});
    ...
    for i=2:numel(xti{n})
        ...
        % tick label
        if (mod(i,2)==1)&&(n<=4)
            text(xti{n}(i),y0_dri_para(n)-lfs-6-10,xtilab{n,i},'fontsize',lfs,'HorizontalAlignment','center','VerticalAlignment','baseline','Interpreter','latex')
        end
    end
...
%         set(gca,'TickLabelInterpreter','latex', 'linewidth',1.5,'FontSize',25,'TickLength',[0.02, 0.01], 'XMinorTick','on');
        ...
        if (mod(i,2)==1)&&(n<=4)
            text(xti{n}(i),y0_dri_perp(n)-lfs-6-10,xtilab{n,i},'fontsize',lfs,'HorizontalAlignment','center','VerticalAlignment','baseline','Interpreter','latex')
        end
    end
    ...
    set(gca,'TickLabelInterpreter','latex', 'linewidth',1.5,'FontSize',85,'XMinorTick','off','Tickdir','in','TickLength',[0.02, 0.01]);
...
for n=1:9
lettere3={'a','b','c','d','e','f','g','h','i'};

 text(let_x0,let_y0,['{\bf ' lettere3{n} '}'],...
        'Interpreter','latex','fontsize',letfs,...
        'HorizontalAlignment','left','VerticalAlignment','baseline')
