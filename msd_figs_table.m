...
[k1, dk1, sig]=round_significance(k_msd_I*1e6, sigma_k_msd_I*1e6);
disp(['k_msd: ' k1 '\pm' dk]) 

disp(['D_msd: ' num2str(D_msd_I*1e12) '+-' num2str(sigma_D_msd_I*1e12) ' um^2/s'])
[k1, dk1, sig]=round_significance(D_msd_I*1e12, sigma_D_msd_I*1e12);
disp(['D_msd: ' k1 '\pm' dk1 ]) 


disp(['gamma_acf:' num2str(gamma_msd_I*1e9) '+-'  num2str(sigma_gamma_msd_I*1e9) ' pN s/um ']);
[k1, dk1, sig]=round_significance(gamma_msd_I*1e9, sigma_gamma_msd_I*1e9);
disp(['gamma_acf:' k1 '\pm' dk1 ]) 


disp(['tau_0:' num2str(tau0_I*1e3) '+-'  num2str(sigma_tau0_I*1e3) ' ms']);
[k1, dk1, sig]=round_significance(tau0_I*1e3, sigma_tau0_I*1e3);
disp(['tau_0:' k1 '\pm' dk1 ]) 
...
[k1, dk1, sig]=round_significance(k_msd_II*1e6, sigma_k_msd_II*1e6);
disp(['k_msd: ' k1 '\pm' dk1]) 

disp(['D_msd: ' num2str(D_msd_II*1e12) '+-' num2str(sigma_D_msd_II*1e12) ' um^2/s'])
[k1, dk1, sig]=round_significance(D_msd_II*1e12, sigma_D_msd_II*1e12);
disp(['D_msd: ' k1 '\pm' dk1 ]) 


disp(['gamma_acf:' num2str(gamma_msd_II*1e9) '+-'  num2str(sigma_gamma_msd_II*1e9) ' pN s/um ']);
[k1, dk1, sig]=round_significance(gamma_msd_II*1e9, sigma_gamma_msd_II*1e9);
disp(['gamma_acf:' k1 '\pm' dk1]) 


disp(['tau_0:' num2str(tau0_II*1e3) '+-'  num2str(sigma_tau0_II*1e3) ' ms']);
[k1, dk1, sig]=round_significance(tau0_II*1e3, sigma_tau0_II*1e3);
disp(['tau_0:' k1 '\pm' dk1 ])
disp('................')
%%
...
[k1, dk1, sig]=round_significance(k_msd_III*1e6, sigma_k_msd_III*1e6);
disp(['k_msd: ' k1 '\pm' dk1 ]) 

disp(['D_msd: ' num2str(D_msd_III*1e12) '+-' num2str(sigma_D_msd_III*1e12) ' um^2/s'])
[k1, dk1, sig]=round_significance(D_msd_III*1e12, sigma_D_msd_III*1e12);
disp(['D_msd: ' k1 '\pm' dk1 ]) 


disp(['gamma_acf:' num2str(gamma_msd_III*1e9) '+-'  num2str(sigma_gamma_msd_III*1e9) ' pN s/um ']);
[k1, dk1, sig]=round_significance(gamma_msd_III*1e9, sigma_gamma_msd_III*1e9);
disp(['gamma_acf:' k1 '\pm' dk1 ]) 


disp(['tau_0:' num2str(tau0_III*1e3) '+-'  num2str(sigma_tau0_III*1e3) ' ms']);
[k1, dk1, sig]=round_significance(tau0_III*1e3, sigma_tau0_III*1e3);
disp(['tau_0:' k1 '\pm' dk1 ])
disp('................')
